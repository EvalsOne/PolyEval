...
from zeval.utils.helpers import fuzzy_match, get_answer, normalize, get_consensus
...
class Matchness:
    ...
    def eval(self, dataset: Dataset, sample_kwargs: Dict[str, Any] = None):
        ...
        match_rule = sample_kwargs['match_rule']
        ignore_case = sample_kwargs['ignore_case']
